...
namespace plant_nanny
{
    ...
    private:
        ...
        std::unordered_map<std::string_view, common::utils::Event> _events;
    ...
    public:
        ...
        void on(std::string_view const &name, common::utils::Event const &event) override;
        void emit(const std::string_view &event) const override;
        // Network management
